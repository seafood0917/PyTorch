...
# Predict the class label and check it against the ground-truth.
# If correct, we add the sample to the list of correct predictions.
...
# the more the network thinks the image is of the particular class.
...
100 * correct / total))
# 54% -> better than chance, which is 10% (randomly picking a class out of 10)
